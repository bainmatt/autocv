...
# TODO: cell to render html resume and pdf resume and copy (+ html to site)
# (workflow will have trouble with latex so run as cell but turn off eval).
  
# TODO: link to the generated docs in repo
# TODO: link to template data files (source) in git repo on data doc pages
