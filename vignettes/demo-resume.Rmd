...
<!-- TODO: add HTML to /docs and link to as
https://bainmatt.github.io/autocv/cv_yourname.html -->

<!-- TODO: add to build workflow to automatically add to docs/ with built site:
...
<!-- TODO: add navbar tab for example cv:
navbar: right: text: "My Page" href: mypage.html -->
